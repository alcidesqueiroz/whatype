...
test('whatype.is function', (t) => {
  ...
  t.notOk(whatype.is('whatever', 'falsy'));
  t.notOk(whatype.is(12, 'falsy'));
  t.notOk(whatype.is({}, 'falsy'));
  t.notOk(whatype.is([], 'falsy'));
  t.notOk(whatype.is(true, 'falsy'));
  t.notOk(whatype.is(new Boolean(1), 'falsy'));
  t.ok(whatype.is('whatever', 'truthy'));
  t.ok(whatype.is(12, 'truthy'));
  t.ok(whatype.is({}, 'truthy'));
  t.ok(whatype.is([], 'truthy'));
  t.ok(whatype.is('bar', 'truthy'));
  t.ok(whatype.is(true, 'truthy'));
  t.ok(whatype.is(new Boolean(1), 'truthy'));
  t.notOk(whatype.is('', 'truthy'));
  t.notOk(whatype.is(new String(''), 'truthy'));
  t.notOk(whatype.is(null, 'truthy'));
  t.notOk(whatype.is(undefined, 'truthy'));
  t.notOk(whatype.is(NaN, 'truthy'));
  t.notOk(whatype.is(0, 'truthy'));
  t.notOk(whatype.is(false, 'truthy'));
  t.notOk(whatype.is(new Boolean(0), 'truthy'));
  ...
  t.notOk(whatype.is('foo', 'string-object'));
  ...
  t.notOk(whatype.is(12, 'number-object'));
  ...
  t.notOk(whatype.is(true, 'boolean-object'));
  ...
  t.ok(whatype.is(-Infinity, '-infinity'));
  t.notOk(whatype.is(Infinity, 'number'));
  t.notOk(whatype.is(-Infinity, 'number'));
  ...
  t.ok(whatype.is(new Date(), 'object'));
  t.ok(whatype.is(new Error(), 'error'));
  t.ok(whatype.is(new Error(), 'object'));
  ...
  t.ok(whatype.is(new Promise(() => {}), 'object'));
